...
create table rol_roles (id bigint not null auto_increment, changed datetime(6), created datetime(6), name varchar(255), primary key (id)) engine=InnoDB;
...
create table trn_tournament (id bigint not null auto_increment, changed datetime(6), created datetime(6), current_rnd integer, name varchar(255), type varchar(255), primary key (id)) engine=InnoDB;
create table use_users (id bigint not null auto_increment, changed datetime(6), created datetime(6), password varchar(255), primary key (id)) engine=InnoDB;
create table utr_users_to_roles (id bigint not null auto_increment, changed datetime(6), created datetime(6), rol_id bigint, use_id bigint, primary key (id)) engine=InnoDB;
...
alter table utr_users_to_roles add constraint FKalyxveltgs7rliybekoqhwwc5 foreign key (rol_id) references rol_roles (id);
alter table utr_users_to_roles add constraint FKauw0taddskj1u9if9owt20eno foreign key (use_id) references use_users (id);
